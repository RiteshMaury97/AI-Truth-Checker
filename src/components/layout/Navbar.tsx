...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className="sticky top-0 z-50 bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg border-b border-gray-200 border-opacity-20"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-3 text-white">
              <FaProjectDiagram className="text-3xl text-cyan-400" />
              <span className="text-2xl font-bold">Deepfake Detector</span>
            </Link>
          </div>
